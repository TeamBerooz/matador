...
function create_config( )
	...
	sudo_users = {464555636,SUDO,BotSuperZedlink_id,BotSuperZedlink_idapi},
	admins = {},
	disabled_channels = {},
...
function load_plugins()
	...
	print('SuperZedlink Version 8.5')
end
--######################################################################--
load_plugins()
--######################################################################--
...
function is_JoinChannel(msg)
	...
	if (not Joinchanel.ok or Joinchanel.result.status == "left" or Joinchanel.result.status == "kicked") and not is_sudo(msg) then
		...
		tdbot.getInlineQueryResults(BotSuperZedlink_idapi, msg.chat_id, 0, 0, "Join", 0, inline_query_cb, nil)
	else
		return true
	end
end
