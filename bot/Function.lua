...
function group_settings(msg, target)
	...
	local gif = (mute_gif == "Warn") and "اخطار" or ((mute_gif == "Kick") and "اخراج" or ((mute_gif == "Mute") and "سکوت" or ((mute_gif == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local photo = (mute_photo == "Warn") and "اخطار" or ((mute_photo == "Kick") and "اخراج" or ((mute_photo == "Mute") and "سکوت" or ((mute_photo == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local sticker = (mute_sticker == "Warn") and "اخطار" or ((mute_sticker == "Kick") and "اخراج" or ((mute_sticker == "Mute") and "سکوت" or ((mute_sticker == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local contact = (mute_contact == "Warn") and "اخطار" or ((mute_contact == "Kick") and "اخراج" or ((mute_contact == "Mute") and "سکوت" or ((mute_contact == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local inline = (mute_inline == "Warn") and "اخطار" or ((mute_inline == "Kick") and "اخراج" or ((mute_inline == "Mute") and "سکوت" or ((mute_inline == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local game = (mute_game == "Warn") and "اخطار" or ((mute_game == "Kick") and "اخراج" or ((mute_game == "Mute") and "سکوت" or ((mute_game == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local text = (mute_text == "Warn") and "اخطار" or ((mute_text == "Kick") and "اخراج" or ((mute_text == "Mute") and "سکوت" or ((mute_text == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local keyboard = (mute_keyboard == "Warn") and "اخطار" or ((mute_keyboard == "Kick") and "اخراج" or ((mute_keyboard == "Mute") and "سکوت" or ((mute_keyboard == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local forward = (mute_forward == "Warn") and "اخطار" or ((mute_forward == "Kick") and "اخراج" or ((mute_forward == "Mute") and "سکوت" or ((mute_forward == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local views = (lock_views == "Warn") and "اخطار" or ((lock_views == "Kick") and "اخراج" or ((lock_views == "Mute") and "سکوت" or ((lock_views == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local location = (mute_location == "Warn") and "اخطار" or ((mute_location == "Kick") and "اخراج" or ((mute_location == "Mute") and "سکوت" or ((mute_location == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local document = (mute_document == "Warn") and "اخطار" or ((mute_document == "Kick") and "اخراج" or ((mute_document == "Mute") and "سکوت" or ((mute_document == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local voice = (mute_voice == "Warn") and "اخطار" or ((mute_voice == "Kick") and "اخراج" or ((mute_voice == "Mute") and "سکوت" or ((mute_voice == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local audio = (mute_audio == "Warn") and "اخطار" or ((mute_audio == "Kick") and "اخراج" or ((mute_audio == "Mute") and "سکوت" or ((mute_audio == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local video = (mute_video == "Warn") and "اخطار" or ((mute_video == "Kick") and "اخراج" or ((mute_video == "Mute") and "سکوت" or ((mute_video == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local video_note = (mute_video_note == "Warn") and "اخطار" or ((mute_video_note == "Kick") and "اخراج" or ((mute_video_note == "Mute") and "سکوت" or ((mute_video_note == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local link = (lock_link == "Warn") and "اخطار" or ((lock_link == "Kick") and "اخراج" or ((lock_link == "Mute") and "سکوت" or ((lock_link == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local tag = (lock_tag == "Warn") and "اخطار" or ((lock_tag == "Kick") and "اخراج" or ((lock_tag == "Mute") and "سکوت" or ((lock_tag == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local username = (lock_username == "Warn") and "اخطار" or ((lock_username == "Kick") and "اخراج" or ((lock_username == "Mute") and "سکوت" or ((lock_username == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local arabic = (lock_arabic == "Warn") and "اخطار" or ((lock_arabic == "Kick") and "اخراج" or ((lock_arabic == "Mute") and "سکوت" or ((lock_arabic == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local mention = (lock_mention == "Warn") and "اخطار" or ((lock_mention == "Kick") and "اخراج" or ((lock_mention == "Mute") and "سکوت" or ((lock_mention == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local edit = (lock_edit == "Warn") and "اخطار" or ((lock_edit == "Kick") and "اخراج" or ((lock_edit == "Mute") and "سکوت" or ((lock_edit == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local markdown = (lock_markdown == "Warn") and "اخطار" or ((lock_markdown == "Kick") and "اخراج" or ((lock_markdown == "Mute") and "سکوت" or ((lock_markdown == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local webpage = (lock_webpage == "Warn") and "اخطار" or ((lock_webpage == "Kick") and "اخراج" or ((lock_webpage == "Mute") and "سکوت" or ((lock_webpage == "Enable") and "SuperZedlinkLock" or "SuperZedlinkUnlock")))
	local bots =  (lock_bots == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local all =  (mute_all == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local tgservice =  (mute_tgservice == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local join =  (lock_join == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local pin =  (lock_pin == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local spam =  (lock_spam == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local flood =  (lock_flood == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local welcome = (lock_welcome == "Enable" and "SuperZedlinkLock" or "SuperZedlinkUnlock")
	local expire_date = ''
	local expi = redis:ttl(RedisIndex..'ExpireDate:'..msg.to.id)
	if expi == -1 then
		expire_date = 'نامحدود!'
	...
	text = string.gsub(text, 'SuperZedlinkUnlock', M_START.."غیرفعال")
	text = string.gsub(text, 'SuperZedlinkLock', M_START.."فعال")
