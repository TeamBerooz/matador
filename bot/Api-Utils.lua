...
function options(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
            {text = "❤️ "..tostring(redis:get(RedisIndex.."SuperZedlinkLikes")), callback_data="/like:"..GP_id},
            {text = "💔 "..tostring(redis:get(RedisIndex.."SuperZedlinkDisLikes")), callback_data="/dislike:"..GP_id}
        },
		{
...
local M_START = StartPm[math.random(#StartPm)]
	...
	keyboard.inline_keyboard = {
		{
			{text = '➢ حداکثر پیام های مکرر ', callback_data = 'BeroozTeam:'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data = 'BeroozTeam:' },
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '➢ حداکثر حروف مجاز ', callback_data = 'BeroozTeam:'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data = 'BeroozTeam:'},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '➢ زمان بررسی پیام های مکرر ', callback_data = 'BeroozTeam:'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data = 'BeroozTeam:'},
...
function helplist(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
            {text = "❤️ "..tostring(redis:get(RedisIndex.."SuperZedlinkLikes")), callback_data="/likehelp:"..GP_id},
            {text = "💔 "..tostring(redis:get(RedisIndex.."SuperZedlinkDisLikes")), callback_data="/dislikehelp:"..GP_id}
        },
		{
...
function addlimpanel(msg, GP_id)
	...
	keyboard.inline_keyboard = {
		{
			{text = '❃ محدودیت اضافه کردن : '..getadd..'', callback_data = 'BeroozTeam:'..GP_id}
		},
		{
		...
		{
			{text = '❃ وضعیت محدودیت : '..sadd..'', callback_data = 'BeroozTeam:'..GP_id}
		},
		{
		...
		{
			{text = '❃ ارسال پیام محدودیت : '..addpm..'', callback_data = 'BeroozTeam:'..GP_id}
		},
		{
