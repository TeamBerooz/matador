...
local function pre_process(msg)
	...
	if not redis:get(RedisIndex.."SuperZedlinkLikes") then redis:set(RedisIndex.."SuperZedlinkLikes",0) end
	if not redis:get(RedisIndex.."SuperZedlinkDisLikes") then redis:set(RedisIndex.."SuperZedlinkDisLikes",0) end
