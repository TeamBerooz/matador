...
if msg.query and msg.query:sub(1,6) == "Addl:-" and msg.query:gsub("Addl:-",""):match('%d+') and is_sudo(msg) then
	...
	keyboard.inline_keyboard = {
		{
			{text = '❃ محدودیت اضافه کردن : '..getadd..'', callback_data = 'BeroozTeam:'..chatid}
		},
		{
		...
		{
			{text = '❃ وضعیت محدودیت : '..sadd..'', callback_data = 'BeroozTeam:'..chatid}
		},
		{
		...
		{
			{text = '❃ ارسال پیام محدودیت : '..addpm..'', callback_data = 'BeroozTeam:'..chatid}
		},
		{
